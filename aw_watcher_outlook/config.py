...
def load_config(testing: bool):
    section = "aw-watcher-outlook" + ("-testing" if testing else "")
    return load_config_toml("aw-watcher-outlook", default_config)[section]
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="A watcher for items selected in Outlook, especially email subjects."
    )
